...
const BookAppointment = () => {
    ...
    const handleConfirm = async () => {
        ...
        const appointmentData = {
            ...
            doctorRefId: selectedDoctor || '',
            doctorName: activeDoctor?.name || 'Any Available Doctor',
            visitType,
            symptoms: finalSymptoms,
            date: appointmentDate.toLocaleDateString('en-IN', { weekday: 'short', month: 'short', day: 'numeric' }),
            appointmentDateKey: appointmentDate.toISOString().split('T')[0],
            time: selectedTime,
            status: 'pending',
            token: tokenNumber,
            consultingFee,
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center gap-2 mt-1">
                                            {doc.rating && <span className="text-[10px] font-bold text-orange-500">â­ {doc.rating}</span>}
                                            {doc.consultingTime && <span className="text-[10px] font-bold text-blue-500">ðŸ• {doc.consultingTime}</span>}
                                        </div>
                                    </div>
